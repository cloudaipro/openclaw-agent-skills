...
TARGET_PROJECT="<your-openclaw-project>"
mkdir -p "$TARGET_PROJECT/skills"
cp -R skills/deconstruction-master "$TARGET_PROJECT/skills/"
```
...
- `<your-openclaw-project>/skills/deconstruction-master`

Runtime entrypoint:
- `<your-openclaw-project>/skills/deconstruction-master/src/index.js`
...
SKILL_ID="deconstruction-master"
