...
TARGET_PROJECT="<your-openclaw-project>"
mkdir -p "$TARGET_PROJECT/skills"
cp -R skills/smart-insightful-friend "$TARGET_PROJECT/skills/"
```
...
- `<your-openclaw-project>/skills/smart-insightful-friend`

Runtime entrypoint:
- `<your-openclaw-project>/skills/smart-insightful-friend/src/index.js`
...
SKILL_ID="smart-insightful-friend"
...
python3 "$PROJECT_SKILLS_DIR/$SKILL_ID/scripts/validate_reasoning_artifacts.py" /tmp/${SKILL_ID}-output.json
```
