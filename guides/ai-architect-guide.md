...
TARGET_PROJECT="<your-openclaw-project>"
mkdir -p "$TARGET_PROJECT/skills"
cp -R skills/ai-architect "$TARGET_PROJECT/skills/"
```
...
- `<your-openclaw-project>/skills/ai-architect`

Runtime entrypoint:
- `<your-openclaw-project>/skills/ai-architect/src/index.js`
