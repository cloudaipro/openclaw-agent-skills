...
TARGET_PROJECT="<your-openclaw-project>"
mkdir -p "$TARGET_PROJECT/skills"
cp -R skills/audience-profiler "$TARGET_PROJECT/skills/"
```
...
- `<your-openclaw-project>/skills/audience-profiler`

Runtime entrypoint:
- `<your-openclaw-project>/skills/audience-profiler/src/index.js`
