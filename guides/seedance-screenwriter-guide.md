...
TARGET_PROJECT="<your-openclaw-project>"
mkdir -p "$TARGET_PROJECT/skills"
cp -R skills/seedance-screenwriter "$TARGET_PROJECT/skills/"
```
...
- `<your-openclaw-project>/skills/seedance-screenwriter`

Runtime entrypoint:
- `<your-openclaw-project>/skills/seedance-screenwriter/src/index.js`
...
SKILL_ID="seedance-screenwriter"
